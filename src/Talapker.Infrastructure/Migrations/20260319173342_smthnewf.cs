...
{
    /// <inheritdoc />
    public partial class smthnewf : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretCodeHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invitations_Institutions_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Institutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    NationalCode = table.Column<string>(type: "text", nullable: false),
                    EducationFieldId = table.Column<Guid>(type: "uuid", nullable: true),
                    Name = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_Kk = table.Column<string>(type: "text", nullable: false),
                    ...
                    WorkPlaces_En = table.Column<string>(type: "text", nullable: false),
                    WorkPlaces_Ru = table.Column<string>(type: "text", nullable: false),
                    WorkPlaces_Kk = table.Column<string>(type: "text", nullable: false),
                    PractiseBases_En = table.Column<string>(type: "text", nullable: false),
                    PractiseBases_Ru = table.Column<string>(type: "text", nullable: false),
                    PractiseBases_Kk = table.Column<string>(type: "text", nullable: false),
                    MinimumUntScore = table.Column<int>(type: "integer", nullable: false),
                    Code = table.Column<string>(type: "text", nullable: false),
                    StudyForm = table.Column<int>(type: "integer", nullable: false),
                    DurationYears = table.Column<decimal>(type: "numeric", nullable: false),
                    Languages = table.Column<int[]>(type: "integer[]", nullable: false),
                    FacultyId = table.Column<Guid>(type: "uuid", nullable: true),
                    EducationGroupId = table.Column<Guid>(type: "uuid", nullable: true),
                    Disciplines = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGrants = table.Column<int>(type: "integer", nullable: false),
                    Degree = table.Column<int>(type: "integer", nullable: false),
                    FrequencyScoreRecords = table.Column<string>(type: "jsonb", nullable: true),
                    OvpoScoreRecords = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProspectId = table.Column<string>(type: "text", nullable: false),
                    AmbassadorId = table.Column<Guid>(type: "uuid", nullable: false),
                    InstitutionId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatRooms_Ambassadors_AmbassadorId",
                        column: x => x.AmbassadorId,
                        principalTable: "Ambassadors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRooms_AspNetUsers_ProspectId",
                        column: x => x.ProspectId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatRooms_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_AmbassadorId",
                table: "ChatRooms",
                column: "AmbassadorId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_InstitutionId",
                table: "ChatRooms",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatRooms_ProspectId_AmbassadorId_InstitutionId",
                table: "ChatRooms",
                columns: new[] { "ProspectId", "AmbassadorId", "InstitutionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitations_Email_TenantId_Role_Status",
                table: "Invitations",
                columns: new[] { "Email", "TenantId", "Role", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Invitations_SecretCodeHash",
                table: "Invitations",
                column: "SecretCodeHash");
